    ...
    <div class="container-lg bookmark-content position-relative"> 
                ...
                <div class="d-flex flex-fill container-lg overflow-hidden text-nowrap">
                    ...
                    <div id="sites-btn-dropdown" class="ml-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-right bg-dark text-center sites-btn-dropdown-list" style="min-width:auto">
                            ...
                            <a class="dropdown-item" href="<?php echo esc_url(home_url().'/user/sites') ?>" target="_blank"><?php _e('管理','i_theme') ?></a>
                        </div>
                    </div>
                </div> 
            </div> 
        ...
        <main id="cust-sites" class="tab-content customize-sites-list mt-4">
            ...
            <div id="my-c-nav" class="sites-pane mb-4 active">                    
                ...
                ?>
                    <div class="url-card col-6 <?php get_columns('sites') ?> <?php echo before_class($post->ID) ?> ">
                ...
                foreach($customize_terms as $c_term){?>
                    <div id="ct-<?php echo $c_term->id ?>" class="customize-sites sites-pane mb-4<?php echo ($i_u == 0?' active':'') ?>">   
                        ...
                        if($c_urls){ 
                            ...
                            ?> 
                            <div id="url-<?php echo $c_url->id ?>" class="url-card sortable col-6 <?php get_columns('sites') ?> ">
                                <div class="url-body mini">
                                    <a href="<?php echo ($is_go ? $c_url->url : go_to($c_url->url))  ?>" target="_blank" class="card new-site mb-3 site-<?php echo $c_url->id ?>" data-id="<?php echo $c_url->id ?>" data-url="<?php echo $c_url->url ?>" title="<?php echo $c_url->url_name ?>" <?php echo  nofollow($c_url->url,false,true) ?>>
            ...
            <div id="my-star" class="sites-pane mb-4">            
                <div class="row row-sm my-star-list">   
                    ...
                    <div class="col-lg-12 customize_nothing_star">
                        <div class="nothing mb-3"><?php _e('您还没有收藏内容！等待你的参与哦 ^_^', 'i_theme' ); ?></div>
                    </div> 
                    <?php }?>
                </div> 
            </div>  
