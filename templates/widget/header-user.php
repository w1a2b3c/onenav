 ...
 * @LastEditors: iowen
 * @LastEditTime: 2023-03-31 23:41:51
...
<li class="nav-login-user dropdown ml-3 ml-md-4">
    ...
    <div  class="dropdown-menu dropdown-menu-right text-center" style="min-width:auto">
		...
		<?php endif; ?>
		<a class="dropdown-item nofx" href="<?php echo wp_logout_url(home_url());?>"><i class="iconfont mr-2 icon-close-circle"></i><?php _e('安全退出','i_theme') ?></a>
	</div>
</li>
