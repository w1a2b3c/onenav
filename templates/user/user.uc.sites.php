                    ...
                    <div class="text-lg pb-3 border-bottom border-light border-2w mb-3 d-flex">
                        ...
                        <div class="ml-auto">
                            <div class="position-relative" data-toggle="tooltip" data-placement="top" title="<?php _e('导入 chrome 书签','i_theme') ?>" style="overflow: hidden">
                                <i class="iconfont icon-upload-wd text-xl"></i>
                        ...
                        <div class="row py-4">
                            ...
                            <div class="sidebar col-6 col-md-9">
                                ...
                                <ul class="drop-add-url position-relative tab-pane sites-lists fade<?php echo ($i_u == 0?' active show':'') ?>" id="terms-<?php echo $c_term->id ?>" role="tabpanel" aria-labelledby="terms-<?php echo $c_term->id ?>-tab">
                                    <div class="row row-sm" data-terms_id="<?php echo $c_term->id ?>">
                                        ...
                                        if($c_urls){ 
                                            ...
                                            foreach($c_urls as $c_url){ 
                                                $ico = (io_get_option('ico-source','https://api.iowen.cn/favicon/','ico_url') .format_url($c_url->url) . io_get_option('ico-source','.png','ico_png'));
                                        ?>
                                    ...
                                    <div class="drag-add-bookmarks rounded position-absolute w-100 h-100 bg-light text-center" style="top:0;display:none" data-terms_id="<?php echo $c_term->id ?>"><div class="h-100 d-flex align-content-center flex-wrap"><span class="mx-auto"><i class="iconfont icon-upload icon-4x d-block text-muted"></i><?php echo sprintf(__('添加书签到“%s”','i_theme'),stripslashes($c_term->name)) ?></span></div></div>
                                </ul>
                                <?php 
                                    $i_u ++;
                                }
