...
global $current_user; 
?>
    <script type="text/javascript" src="<?php echo get_theme_file_uri('/js/webuploader.html5only.min.js') ?>"></script>
                ...
                <div class="card-body">
                    ...
                    <form id="io-change-profile" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <textarea type="text" class="form-control" id="mm_desc" name="mm_desc" placeholder="<?php echo get_user_desc($current_user->ID) ?>"><?php echo esc_attr( $current_user->description ) ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
